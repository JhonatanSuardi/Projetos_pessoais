...
t1.bind(orig) #Vinculando o host com a porta do servidor
t1.listen(1) #Aguardando a conexão (limitado a 1)
while True:

    #Aceita a conexão, retornando o objeto de socket do cliente
    con, cliente = t1.accept() 
    ...
    for i in range (ni):
      ...
      dests = (HOSTS, PORTS) #Definindo o destino Storage
      storage.connect(dests) #Conectando com o destino Storage
